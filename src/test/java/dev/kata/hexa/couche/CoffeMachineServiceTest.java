...
class CoffeMachineServiceTest {
    ...
    @Test
    void orderDrink_WITH_the_and_2_euros_SHOULD_dispense_drink() {
        // Given
        var nomBoisson = "the";
        var montant = 2.0;
    ...
    @Test
    void orderDrink_WITH_the_and_1_euros_SHOULD_not_dispense_drink() {
        // Given
        var nomBoisson = "the";
        var montant = 2.0;
        when(boissonDAO.findByName(nomBoisson)).thenReturn(new Boisson(nomBoisson, montant));
    ...
    @Test
    void orderDrink_WITH_unknow_and_2_euros_SHOULD_send_bad_drink_message() {
        // Given
